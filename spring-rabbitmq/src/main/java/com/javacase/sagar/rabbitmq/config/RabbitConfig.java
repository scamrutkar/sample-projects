package com.javacase.sagar.rabbitmq.config;
...
import com.javacase.sagar.rabbitmq.consumer.Consumer;
...
public class RabbitConfig {
	...
	@Bean
	MessageListenerAdapter listenerAdapter(Consumer messageReceiver) {
